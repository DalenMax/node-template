  ...
  checkSchema(
    {
      name: {
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.NAME_MUST_BE_1_TO_50_CHARACTERS_LONG
        },
        trim: true
      },
      email: {
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            try {
              ...
              throw new ErrorWithStatus((error as JsonWebTokenError).message, HTTP_STATUS.UNAUTHORIZED)
            }
  ...
  checkSchema(
    {
      refresh_token: {
        ...
        custom: {
          options: async (value: string, { req }) => {
            try {
              // verify and check refresh token in database
